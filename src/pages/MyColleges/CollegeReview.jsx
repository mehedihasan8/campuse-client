  ...
  return (
    <>
      <div className="card card-compact w-80 bg-base-400 shadow-xl class-img">
        <figure>
          <img src={imgURL} alt={collegeName} />
        </figure>
        <div className="px-6 py-4">
          <p className="py-1 job-description">
            <span className="font-bold text-slate-700">College Name</span>:{" "}
            {collegeName}
          </p>
          <p className="mb-1 job-description">
          ...
          <p className="mb-1 job-description">
            <span className="font-bold text-slate-700">Candidate Phone</span>:{" "}
            {candidatePhone}
          </p>
          <p className="mb-1 job-description">
          ...
          <p className="mb-1 job-description">
            <span className="font-bold text-slate-700">Address</span>: {address}
          </p>
          <div>
            <form onSubmit={handleReview}>
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  placeholder="rating"
                  name="number"
                  className="px-8 ml-1 py-2 rounded"
                />
              </div>
              <div className=" mt-4 flex">
                <input
                  className="bg-success px-8 ml-1 py-2 rounded"
                  type="submit"
                  value="submit"
                />
              </div>
